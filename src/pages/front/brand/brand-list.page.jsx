                        ...
                        return <Col sm={12} md={6} lg={3} className="mb-3" key={index}>
                            <NavLink to={`/brands/${c.slug}`}>
                                <Card style={{ cursor: "pointer", height: "310px" }}>
                                    <Card.Img variant="top" src={c?.brandImage ? `${import.meta.env.VITE_BASE_URL}/images${c.brandImage}` : noBrandImage} alt={brand + index} style={{ objectFit: "cover", minHeight: "250px", maxHeight: "250px" }} />
